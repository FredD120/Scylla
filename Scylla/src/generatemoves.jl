...
function capture_moves!(board::BoardState, helper, promote_mask, shift, enemy_pcs, info, flag)
...
function enpassant_moves!(board::BoardState, helper, shift, enpassant_sqs, checks, all_pcs, kingpos)
